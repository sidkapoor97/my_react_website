  ...
  return (
    ...
    <ul>
      ...
      <li className="project_item"><h3><a href="/" alt="">Multi Standby Multi Sim Allocation Pattern</a></h3></li>
        ...
        <li className="project_item"><h3><a href="/" alt="">Chest X-Ray image analysis using Deep Learning</a></h3></li>
        ...
        <li className="project_item"><h3><a href="/" alt="">Despeckling of OCT Images</a></h3></li>
